...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='receivedvalues',
            name='image',
            field=models.FileField(blank=True, null=True, upload_to=Sample.models.ReceivedValues.experement_image_path, verbose_name='Изображение образца после эксперимента'),
        ),
        migrations.AlterField(
            model_name='receivedvalues',
            name='time_trials',
